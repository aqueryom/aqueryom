...
public class SearchCriteria extends Criteria {
    ...
    public SearchCriteria(Collection<SearchCondition> criteria, Collection<Ordering> orderings) {
    	super();
    ...
    public SearchCriteria(Collection<SearchCondition> criteria, Collection<Ordering> orderings, int max) {
    	super();
        this.setCriteria(criteria);
        this.setOrderings(orderings);
        this.setClause(AND_CLAUSE);
    ...
    public SearchCriteria(Collection<SearchCondition> criteria, Collection<Ordering> orderings, String clause) {
    	super();
        this.setCriteria(criteria);
        this.setOrderings(orderings);
    ...
    public SearchCriteria(Collection<SearchCondition> criteria, Collection<Ordering> orderings, String clause, int max) {
    	super();
        this.setCriteria(criteria);
        this.setOrderings(orderings);
        this.setClause(clause);
